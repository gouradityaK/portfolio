...
import { SiNextdotjs, SiJavascript, SiMongodb, SiMysql, SiPostgresql } from 'react-icons/si';
          ...
          <div className="w-full lg:w-1/2">
            ...
            <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-4">
              {technologies.map((tech, index) => (
                ...
                >
                  <div className="w-12 h-12 rounded-full bg-indigo-50 flex items-center justify-center mb-2 text-2xl">
                    {tech.icon}
                  </div>
